...
import octopusAdapterRouter from "./octopus-adapter";
...
import knowledgeDigestionRouter from "./knowledge-digestion";
import knowledgeGardenerRouter from "./knowledge-gardener";
...
router.use("/knowledge-gardener", knowledgeGardenerRouter);
